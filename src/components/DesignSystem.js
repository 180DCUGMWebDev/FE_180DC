        ...
        >
          <div className="flex w-full">
            ...
            <div className="w-6/12">
              ...
              <h1 className="text-red180 bg-lightWhite">This is text-red180</h1>
            </div>
          </div>
          <div className="flex w-full">
            <div className="w-6/12">
              <h1 className="font-mulishExtrabold text-[24px]">Headings:</h1>
            ...
            <div className="flex flex-col w-6/12">
              ...
              <div>
                ...
                <p className="font-mulishSemibold text-[18px] text-gray-black180">
                  ...
                  regelialia. Mullish SemiBold 18px
                </p>
              </div>
              <div>
                <h1 className="font-mulishLight text-[14px] text-gray-black180">
                ...
                <p className="font-mulishSemibold text-[14px] text-gray-black180">
                  ...
                  whole heart. Mullish SemiBold 14px
                </p>
              </div>
              <div>
                <h1 className="font-mulishLight text-[14px] text-gray-black180">
                ...
                <a className="font-mulishBold text-[16px] text-blue180 underline" href="">
