...
export default function Footer() {
  ...
  // Classes
  const classHead = "max-lg:mb-[2vw] font-lato-bold text-[5vw] lg:text-[2vw] 2xl:text-[30.7px]";
              ...
              <div className="w-full max-lg:flex max-lg:h-[25%] max-lg:flex-col max-lg:gap-[2vw]">
                <div className="flex w-full items-start">
                  <div className="w-full">
                    <h1 className="font-avenir-regular text-[3.7vw] lg:text-[2vw] 2xl:text-[23px]">
