  ...
  return (
    <section className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-20">
        ...
        {/* Filters and Search */}
        <div className="mb-6 flex flex-col gap-3 rounded-lg border border-neutral-200 bg-white/90 p-6 backdrop-blur-xs">
          ...
          {/* Results Header */}
          <div className="rounded-lg border border-neutral-200 bg-white/90 p-4 backdrop-blur-xs">
