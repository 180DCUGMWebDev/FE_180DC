            ...
            >
              <div className="flex flex-row items-center gap-2">
                ...
                <Label htmlFor="frontend">
                  <p className="font-lato-regular text-gray-600">Frontend Developer</p>
                </Label>
              </div>
              <div className="flex flex-row items-center gap-2">
                <Checkbox
                ...
                <Label htmlFor="backend">
                  <p className="font-lato-regular text-gray-600">Backend Developer</p>
                </Label>
              </div>
              <div className="flex flex-row items-center gap-2">
                <Checkbox
                ...
                />
                <Label htmlFor="uiux">
                  <p className="font-lato-regular text-gray-600">UI/UX Designer</p>
                </Label>
              </div>
            </div>
            {!hasSelectedRole && (
          ...
          <div>
            ...
            <div className="mb-3 font-lato-regular text-sm text-gray-500">
              ...
              <ul className="list-disc pl-5">
                ...
                <li>
                  <span className="font-lato-bold text-black"> Figma Portfolio Folder </span> if you
