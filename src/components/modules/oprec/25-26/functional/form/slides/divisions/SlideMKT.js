            ...
            >
              <div className="flex flex-row items-center gap-2">
                ...
                <Label htmlFor="content">
                  <p className="font-latoRegular text-gray-600">Content</p>
                </Label>
              </div>
              <div className="flex flex-row items-center gap-2">
                <Checkbox
                ...
                <Label htmlFor="graphic-designer">
                  <p className="font-latoRegular text-gray-600">Graphic Designer</p>
                </Label>
              </div>
              <div className="flex flex-row items-center gap-2">
                <Checkbox
                ...
                <Label htmlFor="videographer">
                  <p className="font-latoRegular text-gray-600">Videographer</p>
                </Label>
              </div>
              <div className="flex flex-row items-center gap-2">
                <Checkbox
                ...
                <Label htmlFor="partnership">
                  <p className="font-latoRegular text-gray-600">Partnership</p>
                </Label>
              </div>
            </div>
            {!hasSelectedRole && (
