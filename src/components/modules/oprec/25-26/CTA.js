...
export default function CTA() {
  return (
    <section className="relative bg-gradient-to-b from-gray-900 to-black px-[5%] py-20 sm:px-[10%] lg:px-[4%]">
        ...
        <div>
          <Link href="/oprec/25-26/register" className="inline-block">
            <Button
              color="green"
              text="Apply Now"
              addClass="mt-6 inline-block px-8 py-4 text-lg font-bold transition-all duration-200 hover:scale-105"
            />
          </Link>
        </div>
      </div>
