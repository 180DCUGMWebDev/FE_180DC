            ...
            <div className="mt-[8vw]">
              ...
              <div className="flex h-[21.667vw] w-[21.354vw] flex-col rounded-[1.302vw] bg-white p-[1.302vw]">
                ...
                <div className="mt-[1vw] text-[1.2vw]/[1.7vw]">
                  <h1 className="font-avenir-black text-brand-black text-[1.302vw]">Module 1</h1>
                ...
                <Link
                  ...
                  className="font-lato-bold mt-[1vw] flex h-[3.927vw] w-[19.427vw] items-center justify-center rounded-[1.3vw] border border-black bg-white text-center text-[1.042vw] transition-all duration-700 ease-in-out hover:scale-[102%] hover:bg-[#5AB0BB]/20"
                >
                  Download
                </Link>
              </div>
        ...
        <div className="relative z-2 mt-[20.372vw] flex w-full flex-col items-center lg:hidden">
          <div className="relative flex w-[81.944vw] text-[2vw]/[7vw]">
            ...
            <div className="h-[16.111vw]">
              ...
              <h1 className="font-avenir-black h-[8vw] bg-linear-to-r from-[#6FAA26] to-[#58B9D1] bg-clip-text text-[7.222vw] text-transparent">
                {"Consulting 101"}
              </h1>
            </div>
          </div>
