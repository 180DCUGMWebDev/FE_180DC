    ...
    <section className="relative">
      ...
      <div className="relative flex h-fit w-full items-center justify-center max-lg:py-[8vh] lg:h-screen">
        ...
        <div className="relative mt-[5vw] flex items-center justify-center gap-x-[5vw] max-lg:hidden">
          ...
          <div className="">
            <div>
              <h1 className="font-avenir-black text-[1.563vw] text-white">{data.type}</h1>
            ...
            <div className="mt-[8vw]">
              ...
              <div className="flex h-[21.667vw] w-[21.354vw] flex-col rounded-[1.302vw] bg-white p-[1.302vw]">
                ...
                <div className="mt-[1vw] text-[1.2vw]/[1.7vw]">
                  <h1 className="font-avenir-black text-[1.302vw] text-black">{data.type}</h1>
                  <h1 className="h-[1.8vw] bg-linear-to-r from-[#6FAA26] to-[#58B9D1] bg-clip-text font-avenir-black text-[1.823vw] text-transparent">
                    {data.name}
                  </h1>
                </div>
                <Link
                  href="https://docs.google.com/presentation/d/1Qv1JAEbbzToe7ErGKi9j5mVo-BuR4UWQBoDmpOmiiuQ"
                  className="mt-[1vw] flex h-[3.927vw] w-[19.427vw] items-center justify-center rounded-[1.3vw] border border-black bg-white text-center font-lato-bold text-[1.042vw] transition-all duration-700 ease-in-out hover:scale-[102%] hover:bg-[#5AB0BB]/20"
                >
                  Download
                </Link>
              </div>
        ...
        <div className="relative z-2 mt-[20.372vw] flex w-full flex-col items-center lg:hidden">
          <div className="relative flex w-[81.944vw] text-[2vw]/[7vw]">
            ...
            <div className="h-[16.111vw]">
              <h1 className="font-avenir-heavy text-[5.556vw] text-white">Module 1</h1>
              <h1 className="h-[8vw] bg-linear-to-r from-[#6FAA26] to-[#58B9D1] bg-clip-text font-avenir-black text-[7.222vw] text-transparent">
                {"Consulting 101"}
              </h1>
            </div>
          </div>
          ...
          <div className="relative flex h-[21.742vw] w-[81.944vw] rounded-md bg-white">
            ...
            <div className="mb-[2vw] flex flex-col justify-end text-[2vw]/[4.3vw]">
              <h1 className="font-avenir-black text-[3.333vw] text-black">Module 1</h1>
              <h1 className="h-[5vw] bg-linear-to-r from-[#6FAA26] to-[#58B9D1] bg-clip-text font-avenir-black text-[4.722vw] text-transparent">
                {"Consulting 101"}
              </h1>
            </div>
            <Link
