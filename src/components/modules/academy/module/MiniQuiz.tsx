...
export default function MiniQuiz() {
  ...
  return (
    <section className="bg-brand-black px-[9%]">
      <div className="relative mt-[9.92vw] flex flex-col rounded-[16px] bg-white px-[6%] py-[6%] lg:p-[3.333vw]">
        <div className="flex flex-col">
          <h2 className="font-lato-bold text-brand-primary text-[8vw] lg:text-[2.083vw]">
            Mini Quiz
          </h2>
        ...
        <div className="bg-brand-primary mx-auto my-[2vw] flex w-full flex-col rounded-[16px] px-[6%] py-[6%] lg:my-0 lg:-mt-[5vw] lg:min-h-[40.729vw] lg:w-[36.406vw] lg:rounded-[0.625vw] lg:p-[2.083vw]">
          {isQuizCompleted ? (
        ...
        <div className="mt-4 flex justify-center space-x-2">
          {questionAnswer.map((_, index) => (
            <div
              key={index}
              className={`h-4 w-4 rounded-full ${index <= currentQuestionIndex ? "bg-brand-black" : "bg-gray-300"}`}
            />
          ))}
        </div>
      </div>
