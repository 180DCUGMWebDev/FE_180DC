  ...
  return (
    <div className="relative flex w-[90%] flex-col items-center justify-start rounded-xl bg-white p-[6%] shadow-inner md:w-[48.7%] md:p-[2%]">
      <div className="relative flex aspect-9/3 w-[95%]">
        <div className="absolute top-0 right-0 bottom-0 left-0 m-auto h-full w-full">
...
export const WhatWouldYouGet = () => {
  ...
  return (
    <section className="relative flex h-fit w-full items-center justify-start gap-[3vw] bg-[#E8E8E8] max-md:flex-col max-md:gap-[5vw] max-md:pt-[5%] max-md:pb-[10%] md:min-h-screen md:justify-center lg:gap-[2vw]">
      <Image
        alt="bg bootcamp"
        src="/img/bootcamp/bg-lower-mobile.png"
        width={450}
        height={735}
        className="absolute right-0 bottom-0 left-0 mx-auto w-full lg:hidden"
      />
      <Image
        alt="bg bootcamp"
        ...
        width={1920}
        height={1080}
        className="absolute right-0 bottom-0 left-0 mx-auto w-full max-lg:hidden"
      />
                  ...
                  <tr key={item}>
                    <td className="items-center justify-center">
                      <Image
                        ...
                        width={200}
                        height={200}
                        className="relative right-0 left-0 mx-auto w-[30%]"
                      />
                    </td>
                    <td className="font-avenir-regular w-[70%] p-[1.5%] text-left text-[3.6vw] md:text-[2vw] lg:p-[1.2%] lg:text-[1.3vw] xl:p-[1.1%] 2xl:text-[1.2vw]">
                      {item}
                    </td>
                  </tr>
                );
          ...
          <div className="relative flex h-full min-h-full w-full flex-col justify-evenly px-[2%] max-lg:gap-[2vw]">
            {speakerSessions.map((item, index) => {
              return (
                <div
                  key={item}
                  className="font-avenir-regular relative flex w-full flex-col rounded-lg bg-[#73B743] p-[3%] text-left text-[3.6vw] text-[#FFFFFF] md:rounded-xl md:text-[2vw] lg:p-[2%] lg:text-[1.3vw] xl:p-[2.5%] 2xl:text-[1.2vw]"
                >
