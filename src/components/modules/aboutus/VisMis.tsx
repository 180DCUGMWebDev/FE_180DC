    ...
    return (
      <div id="vismis" className="flex grow flex-col max-lg:w-[94%]">
        ...
        <div className="flex items-end max-lg:items-end">
          <FaBriefcase className="text-brand-primary text-[5vw] max-lg:rotate-[8deg] lg:text-[50px]" />
          <p className="font-lato-bold-italic text-brand-light-white ml-[2vw] text-[3vw]/[2.5vw] lg:ml-[20px] lg:text-[2vw]/[1.9vw] 2xl:text-[31px]/[29px]">
            {title}
          </p>
        </div>
        {/* Content */}
        <div className="mt-[2vw] lg:mt-[20px]">
          <p className="font-lato-regular text-brand-light-white text-justify text-[2.8vw]/[3.3vw] lg:text-[1.3vw]/[1.7vw] 2xl:text-[20px]/[26px]">
            {content}
          </p>
        </div>
      </div>
      ...
      <div className="flex h-fit w-full items-center justify-center max-lg:py-[8vh] lg:h-screen">
        <div className="flex flex-col items-center justify-center px-[6vw] 2xl:w-[1536px] 2xl:px-[100px]">
          ...
          <div className="w-full">
            <h1 className="font-avenir-black text-brand-light-white lg:text-brand-primary text-center text-[8vw]/[7.2vw] lg:text-[4vw]/[3.8vw] 2xl:text-[61px]/[58px]">
              {"180DC UGM"}
              <br />
              <span className="max-lg:text-brand-secondary">{"Vision"}</span>
              {" & "}
              <span className="max-lg:text-brand-primary">{"Mission"}</span>
            </h1>
          </div>
          {/* Vision */}
          <div className="mt-[40px] flex w-full max-lg:flex max-lg:h-fit max-lg:items-center">
            <h2 className="font-avenir-black text-brand-secondary w-[14.2%] text-[2.3vw]/[1.9vw] max-lg:hidden 2xl:text-[35px]/[29px]">
              {"Vision"}
            </h2>
            <div className="flex h-[10vw] w-[6%] justify-start lg:hidden">
              <div className="bg-brand-secondary h-full w-[60%] rounded-[4vw]" />
            </div>
            <p className="font-lato-regular text-brand-light-white w-[94%] text-justify text-[2.8vw]/[3.3vw] lg:w-[85.8%] lg:text-[1.5vw]/[2vw] 2xl:text-[23px]/[30px]">
              {vision}
            </p>
          </div>
          {/* Mision */}
                ...
                return (
                  <div key={title + "_" + idx} className="max-lg:flex">
                    ...
                    <div className="flex h-[16.7vw] w-[6%] justify-start lg:hidden">
                      <div className="bg-brand-primary h-full w-[60%] rounded-[4vw]" />
                    </div>
