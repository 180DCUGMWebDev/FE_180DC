  ...
  return (
    ...
    >
      ...
      <div className="group relative flex w-full flex-col text-center">
        <div className="relative flex flex-row flex-wrap justify-center gap-[3%] font-avenir-black text-[55%] text-[#73B743] transition-all duration-500 hover:text-[#5DA236] sm:text-[60%] md:text-[85%] lg:text-[80%] xl:text-[110%] 2xl:text-[118%]">
          {item.name}
