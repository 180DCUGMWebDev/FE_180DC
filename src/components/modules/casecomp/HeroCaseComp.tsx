        ...
        <div className="relative z-30 flex h-screen flex-col items-center justify-center lg:flex-row">
            ...
            <div className="mt-[3.646vw] hidden w-full flex-col items-center px-4 lg:mt-[1.8vw] lg:flex">
              <div>
                ...
                <div className="flex gap-2">
                  <Button180 color="green" text="Enroll Competition" href={formRef} />
                  <Button180
                    color="white"
                    text="Guidebook"
          ...
          <div className="relative -mt-[20vw] flex w-full flex-col items-center justify-center gap-y-[2vw] px-[8.667vw] lg:hidden">
            <p className="font-lato-semibold text-gray-100-180 flex w-[70vw] justify-center text-center text-[3vw]">
              Calling all aspiring consultants and changemakers! <br /> Join 180DCAPAC Case
              Competition UGM and leave your mark.
            </p>
            <div className="flex w-full flex-col items-center justify-center gap-[2vw]">
              <Button180 color="green" text="Registration" href={formRef} />
              <Button180
                color="white"
                text="Guidebook"
                href="https://drive.google.com/drive/folders/10IN3FGK5FtsdEBzRAWKQkweIHIiShDy-"
