          ...
          {testimonies.map((item, index) => (
            <SwiperSlide key={index} className="relative">
              <div className="relative flex h-full w-full items-center justify-center">
                <div className="flex h-[75vw] w-[92%] max-w-[1200px] flex-col items-center justify-center gap-[1vw] rounded-2xl bg-green-300 max-lg:justify-between max-lg:py-[5vw] max-md:text-[10px] md:h-[58vw] md:text-base lg:h-fit lg:w-[98%] lg:gap-[1.5vw] lg:pt-[5vw] lg:pb-[0]">
