        ...
        <div className="relative">
          ...
          <div className="max-lg:[70vw] relative w-[40vw]">
            ...
            <a
              ...
              className="bg-brand-black font-avenir-heavy relative flex h-[3.75vw] w-[12.677vw] items-center justify-center gap-[1vw] rounded-[5.208vw] text-[1.25vw] text-white transition-all duration-700 ease-in-out hover:scale-[102%] hover:bg-[#5AB0BB]/20 max-lg:mt-[10vw] max-lg:scale-[2] lg:ml-[1.6vw] lg:h-[3.75vw] lg:w-[10.677vw]"
            >
              <Image
          ...
          />
          <div className="flex h-[5.677vw] w-fit flex-col items-center justify-center rounded-[5.208vw] bg-linear-to-r from-[#6FAA26] to-[#58B9D1] px-[2vw] pt-[1vw] font-avenir-black text-[3.333vw] text-brand-light-white lg:mt-[0.5vw] lg:pt-[0.5vw]">
            MERCH
          </div>
