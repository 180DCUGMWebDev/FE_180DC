            ...
            <div className="flex gap-8 max-lg:w-full max-lg:justify-center">
              <Link href="/apply" className="w-[50%] max-lg:max-w-[200px] lg:w-[30%]">
                <Button
                  color="green"
                  text="Consult Now!"
                  addClass="w-full h-fit py-2 lg:py-3 text-sm sm:text-base lg:text-lg transition-transform duration-300 hover:scale-110 hover:bg-gray-800 hover:text-white"
                />
              </Link>
              <Button
                color="green"
                text="Contact Us"
                addClass="w-[30%] h-fit py-3 text-lg max-lg:hidden transition-transform duration-300 hover:scale-110 hover:bg-gray-800 hover:text-white"
        ...
        <div className="flex h-fit flex-col items-center justify-center bg-white max-lg:-mt-[10vh] max-lg:rounded-[12px] max-lg:px-[5%] max-lg:py-[20px] max-lg:drop-shadow-[-2px_3px_5px_#1A1A1A40] lg:h-full">
          ...
          <div className="z-20 flex flex-col gap-[23px] px-[2.3%] max-lg:-mt-[10px] max-lg:items-center">
            ...
            <Link href="/aboutus" className="w-[15%] max-lg:hidden">
              <Button color="black" text="Read More" addClass="w-full h-fit py-3 text-lg transition-transform duration-300 hover:scale-110 hover:bg-gray-800 hover:text-white" />
            </Link>
            <Link href="/aboutus" className="w-[40%] lg:hidden">
              <Button
                color="green"
                text="Read More"
                addClass="w-full h-fit py-2 text-sm sm:text-base transition-transform duration-300 hover:scale-110 hover:bg-gray-800 hover:text-white"
              />
            </Link>
          </div>
        </div>
