      ...
      <div className="flex w-full flex-col">
        ...
        >
          <div className="flex w-full flex-col items-start justify-start gap-2 px-[20px] text-left">
            ...
            <div className="mb-4 mt-6 h-[1px] w-full bg-neutral-200" />
            <Link onClick={closeMobileMenu} className="w-full" href="/apply">
              <div className="w-full rounded-[5px] bg-primary py-[6px] text-center font-mulishBold text-base text-white">
                Consult Now!
              </div>
            </Link>
          </div>
