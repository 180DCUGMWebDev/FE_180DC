      ...
      <div className="relative flex h-screen w-full items-center justify-center max-lg:max-h-[100vmin] lg:h-full">
        ...
        <div className="relative mx-[50px] h-full w-full 2xl:w-[1536px]">
          <div className="flex h-full w-full flex-col items-center justify-center py-[15vh] lg:gap-[16px] lg:p-[100px] 2xl:py-[110px]">
            <h1 className="bg-linear-to-br from-primary from-35% to-secondary to-65% bg-clip-text py-[4px] text-center font-avenir-black text-[7vw] leading-none text-transparent lg:text-[5.4vw]/[6vw] 2xl:text-[83px]/[92px]">
              {"We Look Forward to"}
              <br />
              {"Speaking with You"}
            </h1>
            <h2
              className={
                "mt-[8px] text-center font-lato-regular text-[2.8vw] max-lg:text-light-white lg:text-[1.8vw]/[2.1vw] 2xl:text-[27.6px]/[32.3px] " +
                txtTheme
              }
            >
