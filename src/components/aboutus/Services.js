        ...
        <div className="flex w-full h-fit lg:h-full flex-col justify-center items-center lg:gap-[60px] pt-[20px] pb-[30px] px-[6vw] lg:px-[50px] 2xl:w-[1536px] 2xl:h-fit">
          <div className="flex flex-col lg:flex-row w-full h-fit lg:h-[28%] max-lg:gap-[1vh]">
            ...
            <div className="flex lg:w-7/12 items-end">
              <p className="font-latoRegular text-lightWhite text-justify text-[3vw] lg:text-[2vw]/[2.67vw] 2xl:text-[30.7px]/[41px]">
                {content.desc}
              </p>
            </div>
          </div>
          <div className="flex w-full h-fit justify-center mt-[4vw] lg:gap-[3vw] 2xl:gap-[72px]">
            {/* Cards DESKTOP */}
            {titles.map((val, idx) => {
              return (
                <div
            ...
            {titles.map((val, idx) => {
              return (
                <div
                  key={idx}
                  className="relative lg:hidden flex items-end h-[160px] max-h-full w-full rounded-t-[20px] bg-gradient-to-b from-transparent from-20% to-black to-[58%] p-[1.5vw] pb-0 overflow-clip"
                >
                  {/* Background */}
                  <div
                    className={
