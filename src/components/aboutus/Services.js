...
export default function Services() {
  ...
  return (
    <section className="relative">
      ...
      <div className="w-full h-screen flex flex-col justify-center items-center gap-[60px] pt-[20px] pb-[30px] px-[50px]">
          ...
          {titles.map((val, idx) => {
            return (
              <div className="relative flex items-end h-full w-full rounded-t-[20px] bg-gradient-to-b from-transparent from-20% to-black to-[62%] p-[30px] pb-0 overflow-clip">
                {/* Background */}
                <div
                  className={"absolute -z-[1] w-[150%] " + values[idx].position}
                >
