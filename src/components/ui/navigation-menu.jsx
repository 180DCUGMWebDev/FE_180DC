...
const NavigationMenu = React.forwardRef(({ className, children, viewport, ...props }, ref) => (
...
const NavigationMenuContent = React.forwardRef(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ref={ref}
    className={cn(
      "data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out data-[motion=from-end]:slide-in-from-right-52 data-[motion=from-start]:slide-in-from-left-52 data-[motion=to-end]:slide-out-to-right-52 data-[motion=to-start]:slide-out-to-left-52 left-0 h-fit w-full rounded-xl bg-white p-1 text-black transition-all duration-300 md:absolute md:w-auto lg:mt-[4px] lg:border-[1px] lg:p-4",
      className,
    )}
    {...props}
  />
